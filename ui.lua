...
function ui.draw.levelSelect(level, subgame)
    ...
    if subgame == 0 then
        ...
        gfxopts.gPrint("Marathon", 310, 50)
        love.graphics.setFont(font)
        gfxopts.gPrint("The standard mode for Tetris!", 250, 100)
        gfxopts.gPrint("Clear 600 lines over 15 levels.", 250, 130)
    elseif subgame == 1 then
        gfxopts.sColor(1,1,1,1)
        love.graphics.setFont(bigFont)
        gfxopts.gPrint("Sprint", 330, 50)
        love.graphics.setFont(font)
        gfxopts.gPrint("How fast can you clear?", 280, 100)
        gfxopts.gPrint("Clear 40 lines as quickly as you can.", 230, 130)
    elseif subgame == 2 then
        gfxopts.sColor(1,1,1,1)
        love.graphics.setFont(bigFont)
        gfxopts.gPrint("Ultra", 330, 50)
        love.graphics.setFont(font)
        gfxopts.gPrint("A race against the clock!", 280, 100)
        gfxopts.gPrint("Clear as many lines as you can in two minutes.", 150, 130)
    end
    gfxopts.gDraw(images.back, 5, 5, 0, 0.5, 0.5)
